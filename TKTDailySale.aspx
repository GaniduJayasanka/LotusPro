<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TKTDailySale.aspx.cs" Inherits="TKTDailySale" EnableEventValidation="false" %>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h5 class="m-0">Ticket Daily Sale</h5>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Ticket Daily Sale</a></li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <asp:GridView ID="gvTicketSale" runat="server" AutoGenerateColumns="False" Font-Size="Small"  Width="100%" ShowFooter="true" OnRowDataBound="gvTicketSale_RowDataBound">
                                    ...
                                    <Columns>
                                        <asp:TemplateField  HeaderText="BillId" Visible="true">
                                            <itemtemplate>
                                                <asp:Label ID="lblBillId" runat="server" Font-Bold="true" Text='<%#Eval("BillId") %>'></asp:Label>
                                            </itemtemplate>
                                        </asp:TemplateField>
                                                   
                                                         <asp:TemplateField HeaderText="Bill No" Visible="true" FooterStyle-Font-Bold="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labBillNo" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("BillNo") %>'></asp:Label>
                                                             </ItemTemplate>
                                                              <FooterTemplate>
                                                <div>
                                        ...
                                        <asp:TemplateField HeaderText="No of Tickets" Visible="true" FooterStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                                 <asp:Label ID="labNoofTickets" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("NoofTickets") %>'></asp:Label>
                                               </ItemTemplate>
                                             <FooterTemplate>
                                                <div>
                                                    <asp:Label ID="lblTotalNoOfTickets" runat="server"  />
                                                </div>
                                            </FooterTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Bill Date & Time" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="lblBilldateNTime" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("BilldateNTime") %>'></asp:Label>
                                                             </ItemTemplate>                                                            
                                                         </asp:TemplateField>

                                                         <asp:TemplateField HeaderText="Total Bill Amount" Visible="true" ItemStyle-HorizontalAlign="Right" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right">
                                                             <ItemTemplate>
                                                               <asp:Label ID="lblTotBillAmount" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("TotBillAmount","{0:N2}") %>'></asp:Label>
                                                             </ItemTemplate>   
                                                              <FooterTemplate>
                                                <div>
                                                    <asp:Label ID="lblTotalBillAmount" runat="server" />
                                                           ...
                                                           <asp:TemplateField HeaderText="Billed User" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labUserName" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("UserName") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Void Status" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="lblVoidStatus" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("VoidStatus") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>                                                   
