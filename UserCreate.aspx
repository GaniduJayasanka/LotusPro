...
<head>
    ...
    <title>LotusPro | User Creation</title>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        ...
                        <br />
                        <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" Height="30px" class="form-control" ></asp:TextBox>  
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                     ...
                     <div class="col-sm-9">
                      ...
                      <div class="form-group">
                        ...
                        <br />
                        <asp:TextBox ID="txtComment" Height="30px" runat="server" class="form-control" ></asp:TextBox>  
                      </div>
                    </div>
                 ...
                 <HeaderStyle BackColor="#333333" Font-Bold="True"  ForeColor="White"  />
                    <Columns>                               
                     <asp:TemplateField HeaderText="User Name" Visible="true" >
                            ...
                            <ItemTemplate>                           
                                <asp:Label ID="lblReportEmail" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Email") %>'></asp:Label>
                            </ItemTemplate>                                         
                        </asp:TemplateField>                                 
