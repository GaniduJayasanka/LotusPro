<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TGPClaimReport.aspx.cs" Inherits="TGPClaimnReport" %>
...
<head>
 ...
 <link rel="shortcut icon" type="image/ico" href="dist/img/lotusProLog.ico" />
  ...
  <title>LotusPro | Tour Guide Management System</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5>Tour Guide Points Claim Application</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="Home.aspx">Home</a></li>
                 <li class="breadcrumb-item"><a href="TGMange.aspx">Tour Guide Management</a></li>
              <li class="breadcrumb-item active">Tour Guide Points Claim Application</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="bg-white shadow-md rounded-lg">
        <div class="filter-container">
            ...
            <div>
             ...
             <div>
                <asp:Button ID="btnViewTGP" runat="server" Text="View" CssClass="btn-filter" OnClick="btnView_Click" />
            </div>
             <div>
                <asp:Button ID="BtnClaim" runat="server" Text="Claim Process"  CssClass="btn-claim" OnClick="BtnClaim_Click" />
            </div>
           

            
           <div class="export-buttons">
           <asp:Button ID="Button1" runat="server" Text="Export to Excel" CssClass="btn-export-excell" OnClick="btnExportTGExcel_Click" />

        </div>
        </div>

      <div class="table-container">
    <asp:GridView ID="gvTGPReport" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvTGPReport_RowDataBound" OnRowCommand="gvTGPReport_RowCommand"
    CssClass="border-table" ShowFooter="True">
        <Columns>
           ...
           <%-- <asp:BoundField HeaderText="Claimed Status" DataField="ClaimedStatus" />
            ...
            <asp:TemplateField HeaderText="Claim">
                <ItemTemplate>
                 <asp:Button ID="btnClaim" runat="server" Text="Claim" CommandName="Claim" CommandArgument='<%# Eval("TGHid") %>' CssClass="btn btn-success btn-sm" />
      ...
      <asp:Label ID="lblClaimId" runat="server" Text="0" Visible="false"></asp:Label>
