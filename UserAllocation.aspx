<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserAllocation.aspx.cs" Inherits="UserAllocation" %>
...
<head>
    ...
    <title>LotusPro | Web Forms</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5>Web Form User Allocation</h5>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="Home.aspx">Home</a></li>
                <li class="breadcrumb-item"><a href="AdminPanel.aspx">Admin Panel</a></li>
              <li class="breadcrumb-item active">Web Form User Allocation</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="col-md-3">
            <div class="form-group">
                ...
                <asp:DropDownList ID="DD1" class="form-control" runat="server" Height="33px" AutoPostBack="True" OnSelectedIndexChanged="DD1_SelectedIndexChanged">
                </asp:DropDownList>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <asp:Label ID="lblUserName" runat="server" CssClass="form-control-static" />
            </div>
        </div>       
              </div>
              <!-- /.card-body -->
               ...
               <div class="col-auto d-flex align-items-center">
                      <div class="btn-group">
             <asp:Button ID="btnView" runat="server" Text="View" CssClass="btn btn-primary" Width="120px" Height="40px" Style="margin-left: 5px" onclick="btnView_Click" /> 
      <asp:Button ID="BtnSave" class="btn btn-success start" runat="server" Width="120px"    Text="Save" OnClick="BtnSave_Click"  />
                       
         <asp:Button ID="BtnReset" class="btn btn-warning start" runat="server" Width="120px" Text="Reset"  onclick="BtnReset_Click" />
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
                <asp:GridView ID="GVForm" runat="server" AutoGenerateColumns="False" BackColor="White"
              BorderWidth="1px" CellPadding="4" EnableModelValidation="True" ForeColor="Black" Width="100%" Font-Size="Smaller"  >
                 <HeaderStyle BackColor="#333333" Font-Bold="True"  ForeColor="White"  />
                    <Columns>
                         <asp:TemplateField HeaderText="Form Id" Visible="true" >
                            <ItemTemplate>                           
                                <asp:Label ID="lblFormId" runat="server" Visible="true" Text='<%#Eval("FormId") %>'></asp:Label>
                            </ItemTemplate>                                     
                        </asp:TemplateField>
                     <asp:TemplateField HeaderText="Web Form" Visible="true" >
                            <ItemTemplate>                           
                                <asp:Label ID="lblWebForm" runat="server" Visible="true" Text='<%#Eval("WebForm") %>'></asp:Label>
                            </ItemTemplate>                                     
                        </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Description" Visible="true" >
                            <ItemTemplate>                           
                                <asp:Label ID="lblDescription" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Description") %>'></asp:Label>
                            </ItemTemplate>                                         
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Selection" Visible="true">
