<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TKTPriceWiseSale.aspx.cs" Inherits="TKTPriceWiseSale" %>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h5 class="m-0">Ticket Sale - Summary Report (Value Wise)</h5>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Ticket Sale - Summary Report - Value Wise</a></li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                                             ...
                                             <FooterTemplate>
                                                <div>
                                                    <asp:Label ID="lblTotalNoOfTickets" runat="server" />
                                                         ...
                                                         <asp:TemplateField HeaderText="Ticket Type" Visible="true" ItemStyle-HorizontalAlign="Left">
                                                             <ItemTemplate>
                                                               <asp:Label ID="lblTicketType" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("TicketType") %>'></asp:Label>
                                                             </ItemTemplate>                                                            
                                                         </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Unit Price" Visible="true" ItemStyle-HorizontalAlign="Left">
                                                             <ItemTemplate>
                                                               <asp:Label ID="lblUnitPrice" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("UnitPrice") %>'></asp:Label>
                                                             </ItemTemplate>                                                            
                                                         </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Ticket Sold (Qty)" Visible="true" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                                                             <ItemTemplate>
                                                               <asp:Label ID="lblTicketSold" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("TicketSold") %>'></asp:Label>
                                                             </ItemTemplate>    
                                             <FooterTemplate> <div> <asp:Label ID="lblTotalTicketSold" runat="server" /> </div>  </FooterTemplate>
                                                         </asp:TemplateField>
