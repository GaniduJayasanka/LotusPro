<%@ page language="C#" autoeventwireup="true" inherits="DNAcknowledge, App_Web_11yxmj2e" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-11">
                    <center><h3>Acknowledge - Debit Notes</h3></center>
                </div>
            </div>
        </div>
            ...
            <asp:GridView ID="GVMSPShedule" runat="server"     DataKeyNames="DEBID" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" 
                ...
                <Columns>
                     <asp:TemplateField HeaderText="" >
                        <ItemTemplate>
                            <asp:Button ID="btnAcknowledge"  runat="server" Text="Acknowledge"  CssClass="btn btn-success"  OnClick="btnAcknowledge_Click" />
                        </ItemTemplate>
                    </asp:TemplateField>              
                     <asp:TemplateField HeaderText="" >
                        <ItemTemplate>
