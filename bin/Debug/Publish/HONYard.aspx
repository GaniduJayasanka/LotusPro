<%@ page language="C#" autoeventwireup="true" inherits="HONYard, App_Web_euilynsb" %>
...
<body>
      <form id="form1" runat="server">
        <h3 style="text-align: center; margin-top: 10px; margin-bottom: 10px; max-width: 90%">SHIPMENT MOVEMENTS CONSOLE</h3>
        <div class="col-md-12">
                ...
                <div class="box box-success" style="padding: 10px 10px 10px 10px; background-color: #eeeeee">
                    <div class="box-body">
                        <a class="col-md-4 col-sm-6 col-xs-12" href="Home.aspx">
                         ...
                         <a class="col-md-4 col-sm-6 col-xs-12" href="CommercialCargoHO.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-aqua">
                                    <img src="Images/ITtransfer.png" width="80%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Deliveries(Cargo @ HO)</span>
                                </div>
                            </div>
                        </a>
                         ...
                         <a class="col-md-4 col-sm-6 col-xs-12" href="YardToHo.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-orange">
                                    <img src="Images/moven.png" width="80%" />
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Yard to HO Conversion</span>
                                </div>
                            </div>
                        </a>
