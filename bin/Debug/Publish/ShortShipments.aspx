<%@ page language="C#" autoeventwireup="true" inherits="ShortShipments, App_Web_cjp5ygzm" %>
...
<%--<div style="overflow:auto;" onscroll="OnScrollDiv(this)" id="DivMainContent" >--%>
            <asp:GridView ID="GVMSPShedule" runat="server"  DataKeyNames="OrderNo" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" 
                ...
                EnableModelValidation="True" OnRowDataBound="GVMSPShedule_RowDataBound1"  >
               
                <Columns>
                    <asp:TemplateField HeaderText="Add to Schedule" SortExpression="" >
                        <ItemTemplate>
                    <asp:ImageButton ID="imgbtnAddToShedule" OnClick="imgbtnAddToShedule_Click" runat="server"  Height="30px" ImageUrl="~/images/Resend.png" ToolTip="Add to Schedule" Width="30px" />
                     </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Send to S. Ship Approval"  SortExpression="" >
                        <ItemTemplate>
                    <asp:ImageButton ID="imgbtnSend"  OnClick="imgbtnSend_Click" runat="server"  Height="30px" ImageUrl="~/images/send.png" ToolTip="Send to short Shipment Approval" Width="30px" />
                     </ItemTemplate>
                    </asp:TemplateField>
                   ...
                   <asp:TemplateField HeaderText="BPONo" Visible="true">
                    ...
                    <asp:TemplateField HeaderText="Ex. Ship Date" Visible="true">
                     ...
                     <asp:TemplateField HeaderText="SPOQty" Visible="false">
                        <ItemTemplate> 
