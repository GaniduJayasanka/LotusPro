<%@ page language="C#" autoeventwireup="true" inherits="CHCancellApproval, App_Web_b2ychy0x" %>
...
<head id="Head1" runat="server">
    <title>Cargo @ HO Shipments Cancellation Approval</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-11">
                    <center><h3>Cargo @ HO Shipments Cancellation Approval</h3></center>
                </div>
            </div>
        </div>
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="BPONo" Visible="true" SortExpression="BuyerPONo">
                    ...
                    <asp:TemplateField HeaderText="Ex. Ship Date" Visible="true" SortExpression="ExtendedShipDate">
                     ...
                     <asp:TemplateField HeaderText="SPOQty" Visible="false" SortExpression="SPOQty">
                        <ItemTemplate>
