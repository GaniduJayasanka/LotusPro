<%@ page language="C#" autoeventwireup="true" inherits="SRNote_PendingApproval, App_Web_34neb3g4" %>
            ...
            <asp:Panel ID="PanelMain" runat="server" Font-Names="Tahoma" Font-Size="Small">
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td class="auto-style13">&nbsp;</td>
                        <td>
                            <img alt="Preview Copy" runat="server" id="ImgWatermark" class="auto-style14" mce_src="images/ApprovalPendingWatermark.png" src="images/ApprovalPendingWatermark.png" style="opacity:0.2;filter:alpha(opacity=20); "></img></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:GridView ID="GVDispatchInfo" runat="server" AutoGenerateColumns="false" Font-Names="Tahoma" Font-Size="Medium" Width="746px">
                                            <Columns>
                                                <asp:BoundField DataField="StyleNo" ItemStyle-Width="2000px" HeaderText="Style No" />
