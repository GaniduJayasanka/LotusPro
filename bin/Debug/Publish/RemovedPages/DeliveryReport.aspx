<%@ page language="C#" autoeventwireup="true" inherits="De, App_Web_a2krn21a" enableeventvalidation="false" %>
...
<body>
    ...
    <script type="text/javascript">
        function multiopen() {
            ...
            <ContentTemplate>   
                                         <asp:Button ID="btnsearch" CssClass="btn btn-info" runat="server" Text="Search" OnClick="btnsearch_Click" style="height: 36px; width: 69px" />
                           </ContentTemplate>       
         </asp:UpdatePanel>
</div>
                                    </div>
