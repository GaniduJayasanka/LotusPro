<%@ page language="C#" autoeventwireup="true" inherits="BuyerReceivables, App_Web_sdwe5enq" %>
               ...
               <div class="row">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="60 > 90 days" ItemStyle-BackColor="#ff99ff" ItemStyle-HorizontalAlign="Right" SortExpression="" Visible="true">
                     ...
                     <asp:TemplateField HeaderText="> 90 days"  ItemStyle-BackColor="#ff2d3d" ItemStyle-HorizontalAlign="Right" SortExpression="" Visible="true">
                        <ItemTemplate>
