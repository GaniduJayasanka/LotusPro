<%@ page language="C#" autoeventwireup="true" inherits="ShipmentAlert, App_Web_a2krn21a" %>
                    ...
                    <div class="col-sm-12">
                               ...
                               <asp:TemplateField HeaderText="Reason for OT" Visible="true">
                                ...
                                <div>
                                    ...
                                    <asp:GridView ID="GVShipmentAlertSW" OnDataBound="GVShipmentAlertSW_DataBound"
                                         ...
                                         Font-Size="14px" Width="100%" EnableModelValidation="True" ShowFooter="true">
                                        <HeaderStyle BackColor="#333333" ForeColor="White" />
                                        <Columns>
                                            <%--  <asp:TemplateField HeaderText="OTRID" SortExpression="" Visible="False">
                              <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Request Date">
                                    <ItemTemplate>
                                        <asp:Label ID="LblOTRDate" runat="server" Text='<%#Eval("OTRDate","{0:dd/MMM/yyyy}") %>' />
                                            ...
                                            <asp:TemplateField FooterStyle-HorizontalAlign="Right" HeaderText="Sumithra PO Qty" ItemStyle-HorizontalAlign="Right">
                                                <ItemTemplate>
                                                    <asp:Label ID="SumithraPOQty" runat="server" Text='<%# Eval("SumithraPOQty") %>' />
                                                </ItemTemplate>
                                                <FooterTemplate >
                            ...
                            <asp:Label ID="ExtendedShipDate" runat="server" Font-Bold="true" Text='<%#Eval("ExtendedShipDate","{0:dd/MMM/yyyy}") %>'></asp:Label>
                               ...
                               <asp:TemplateField HeaderText="Reason for OT" Visible="true">
                                ...
                                <div>
                                    ...
                                    <asp:GridView ID="GVShipmentAlertSP" ShowFooter="true" OnDataBound="GVShipmentAlertSP_DataBound" OnRowCreated="GVShipmentAlertSP_RowCreated" OnSorting="GVShipmentAlertSP_Sorting" OnRowDataBound="GVShipmentAlertSP_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="14px" Width="100%" EnableModelValidation="True">
                                        <HeaderStyle BackColor="#333333" ForeColor="White" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="Plant" SortExpression="Plant">
                                                <ItemTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="ExtendedShipDate" Font-Bold="true" runat="server" Text='<%#Eval("ExtendedShipDate","{0:dd/MMM/yyyy}") %>'></asp:Label>
                                 ...
                                 <div>
                                    <br />
                                    <asp:GridView ID="GVShipmentAlertSH" ShowFooter="true" OnDataBound="GVShipmentAlertSH_DataBound" OnRowCreated="GVShipmentAlertSH_RowCreated" OnSorting="GVShipmentAlertSH_Sorting" OnRowDataBound="GVShipmentAlertSH_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="14px" Width="100%" EnableModelValidation="True">
                                        <HeaderStyle BackColor="#333333" ForeColor="White" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="Plant" SortExpression="Plant">
                                                <ItemTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="ExtendedShipDate" Font-Bold="true" runat="server" Text='<%#Eval("ExtendedShipDate","{0:dd/MMM/yyyy}") %>'></asp:Label>
                                  ...
                                  <div>
                                    <br />
                                    <asp:GridView ID="GVShipmentAlertSN" ShowFooter="true" OnDataBound="GVShipmentAlertSN_DataBound" OnRowCreated="GVShipmentAlertSN_RowCreated" OnSorting="GVShipmentAlertSN_Sorting" OnRowDataBound="GVShipmentAlertSN_RowDataBound" runat="server" AutoGenerateColumns="False" Font-Size="14px" Width="100%" EnableModelValidation="True">
                                        <HeaderStyle BackColor="#333333" ForeColor="White" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="Plant" SortExpression="Plant">
                                                <ItemTemplate>
