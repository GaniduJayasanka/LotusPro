<%@ page language="C#" autoeventwireup="true" inherits="De, App_Web_l2xyesqa" enableeventvalidation="false" %>
...
<body>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                       ...
                       <%-- <asp:LinkButton ID="LinkButton2" PostBackUrl="~/PlantWiseDeliveryRep.aspx" ToolTip="Drill Down Report" runat="server">Drill Down </asp:LinkButton>  |
                        ...
                        --%>
                         <a href="DashboardFourLevel.aspx"  target="_blank">  <asp:Label ID="Label8" runat="server" ToolTip="MSP Dashboard" Text="Dashboard" type="button"></asp:Label>   </a> |
                         <a href="PlantWiseDeliveryRep.aspx" ToolTip="Drill Down Report" target="_blank">  <asp:Label ID="Label7" runat="server" ToolTip="Drill Down Report" Text="Drill Down" type="button"></asp:Label></a> |
                         <a href="SerialNoWiseDeliveryRpt.aspx" target="_blank"> <asp:Label ID="Label6" runat="server" ToolTip="Serial No Wise Delivery Plan" Text="Serial No" type="button"></asp:Label>    </a> |
                         <a href="PlantWiseDeliveryReport.aspx" target="_blank"><asp:Label ID="Label5" runat="server" ToolTip="Plant Wise Delivery Report" Text="Plant" type="button"></asp:Label>     </a> |
                         <a href="StyleWiseHistory.aspx" target="_blank">     <asp:Label ID="Button1" runat="server" ToolTip="Style Wise Log Report" Text="Log" type="button"></asp:Label>  </a> |
                                   ...
                                   <%--  <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                     <%--  <img src="images/tab.png" width="20px" onclick="multiopen()"/>--%>
                                         <asp:ImageButton ImageUrl="images/Excel-32.png" Width="28px" runat="server" ToolTip="Export To Excel" OnClick="btnExcel_Click" ID="btnExcel" />
                                        <asp:ImageButton ImageUrl="images/tab.png" Width="24px" runat="server" ToolTip="Plant in Tabs" OnClick="btntab_Click" ID="btntab" />
    ...
    <script type="text/javascript">
        function multiopen() {
            ...
            window.open("DeliveryReport.aspx?type=1&FromDate=" + FromDate + "@ToDate=" + ToDate + "", '_blank');
            window.open('DeliveryReport.aspx?type=2', '_blank');
            window.open('DeliveryReport.aspx?type=3', '_blank');
            window.open('DeliveryReport.aspx?type=4', '_blank');
        }
    </script> <asp:Button ID="btnsearch" CssClass="btn btn-info" runat="server" Text="Search" OnClick="btnsearch_Click" style="height: 36px; width: 89px" />
                                    </div>
  ...
  <%--<input type="checkbox"  ID="CheckBox1"   checked="checked" runat="server" visible="true">--%>
                                             <asp:CheckBox ID="CheckBox1" AutoPostBack="true" OnCheckedChanged="CheckBox1_CheckedChanged"  checked="true" runat="server" />
 ...
 <asp:TemplateField HeaderText="HandedOver" Visible="false">
                       ...
                       <asp:TemplateField HeaderText="CancelRequest" Visible="false" SortExpression="Cancel">
                        <ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="So Far Dispatched"  Visible="true">
                            <ItemTemplate>                           
