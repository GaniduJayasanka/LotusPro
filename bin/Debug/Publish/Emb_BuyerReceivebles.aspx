<%@ page language="C#" autoeventwireup="true" inherits="Emb_BuyerReceivebles, App_Web_10bhy3il" %>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-9">
                        <h2 style="font-family:Bahnschrift;text-align: center" >Buyer Wise Receivables Age Analysis - Embroidery Invoices</h2>
                    </div>
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                         ...
                                         <div class="col-md-1">
                                        <asp:Button ID="btnviewDetails" CssClass="btn btn-success" runat="server" Text="View Details" OnClick="btnviewDetails_Click" />
