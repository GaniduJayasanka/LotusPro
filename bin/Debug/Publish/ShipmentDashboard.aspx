<%@ page language="C#" autoeventwireup="true" inherits="ShipmentDashboard, App_Web_cjp5ygzm" %>
        ...
        <asp:HiddenField ID="hfRemainingValue" runat="server" />
         ...
         <asp:UpdateProgress runat="server" ID="PageUpdateProgress">
            <ProgressTemplate>
                ...
                <div class="modalrt">
                    <div class="center">
                        <img alt="" src="images/Wait_image.gif" />
                    </div>
                </div>
            </ProgressTemplate>
        </asp:UpdateProgress>
         ...
         <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10">
                  ...
                  <div class="col-md-1">
                    <br />
                    <asp:ImageButton ToolTip="About" ID="btnAbout" runat="server" ImageUrl="~/images/about.png" Height="35px"
                        Width="35px" OnClick="btnAbout_Click" />
                </div>
            </div>
        </div>
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="PlantID" SortExpression="PlantID" Visible="false">
                            ...
                            <asp:TemplateField HeaderText="No. Of Styles" Visible="false" ItemStyle-HorizontalAlign="Right" SortExpression="NoOfStyles">
                             ...
                             <asp:TemplateField HeaderText="BPO Qty" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="BPOQty">
                                <ItemTemplate>
                                    <asp:Label ID="BPOQty" runat="server" Text='<%#Eval("BPOQty","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>                               
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="SPO Qty" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="SPOQty">
                                <ItemTemplate>
                                    <asp:Label ID="SPOQty" runat="server" Text='<%#Eval("SPOQty","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>                               
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="BPO / SPO Variance" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="BPOSPOVariance">
                                <ItemTemplate>
                                    <asp:Label ID="BPOSPOVariance" runat="server" Text='<%#Eval("BPOSPOVariance","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>                               
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Commited Qty" Visible="false" ItemStyle-HorizontalAlign="Right" SortExpression="CommitedQty">
                                <ItemTemplate>
                                    <asp:Label ID="CommitedQty" runat="server" Text='<%#Eval("CommitedQty","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>                               
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Shipped Qty" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="ShippedQty">
                                <ItemTemplate>
                                    <asp:Label ID="ShippedQty" runat="server" Text='<%#Eval("ShippedQty","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>                                
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Short/Over Qty (From BPO)" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="ShortOver_Qty">
                                <ItemTemplate>
                                    <asp:Label ID="ShortOver_Qty" runat="server" ToolTip="(Shipped Qty - BPO Qty)" Text='<%#Eval("ShortOver_Qty","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Short/Over Ship Value ($)" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="ShortShipValue">
                              ...
                              <asp:TemplateField HeaderText="SPO/SHIP Var" ItemStyle-HorizontalAlign="Right" Visible="true">
                                <ItemTemplate>
                                   <asp:Label ID="lblbyrSPOShipVariance" runat="server" Text='<%#Eval("SPOShipVariance","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>
                               <FooterTemplate>
                             <asp:Label ID="LblFooterbuyerSPOShipVariance" runat="server" ></asp:Label>                                                                       
                              </FooterTemplate>
                              </asp:TemplateField>
                             <asp:TemplateField HeaderText="SPO/SHIP Var. Value" ItemStyle-HorizontalAlign="Right" Visible="true">
                                <ItemTemplate>
                                   <asp:Label ID="lblSPOShipVarValue" runat="server" Text='<%#Eval("SPOShipVarValue","{0:n}") %>'></asp:Label>
                                </ItemTemplate>
                               <FooterTemplate>
                             <asp:Label ID="LblFooterSPOShipVarValue" runat="server" ></asp:Label>                                                                       
                              </FooterTemplate>
                              </asp:TemplateField>
                        </Columns>
...
<table> <tr>
                    ...
                    <asp:GridView ID="GVMSPShedule" ShowFooter="true" OnRowDataBound="GVMSPShedule_RowDataBound" runat="server" OnSorting="GVMSPShedule_Sorting" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC"
                        ...
                        <Columns>
                          ...
                          <asp:TemplateField HeaderText="No. Of Styles" Visible="false" ItemStyle-HorizontalAlign="Right" SortExpression="NoOfStyles">
                            ...
                            <asp:TemplateField HeaderText="SPO Qty" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="SPOQty">
                             ...
                             <asp:TemplateField HeaderText="BPO / SPO Variance" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="BPOSPOVariance">
                                ...
                                <FooterTemplate>
                                    <asp:Label ID="lblTotalBPOSPOVar" runat="server" Visible="true" ></asp:Label>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Commited Qty" Visible="false" ItemStyle-HorizontalAlign="Right" SortExpression="CommitedQty">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Short/Over Qty (From BPO)" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="ShortOver_Qty">
                                <ItemTemplate>
                                    <asp:Label ID="ShortOver_Qty" ToolTip="(Shipped Qty - BPO Qty)" runat="server" Text=' <%#Eval("ShortOver_Qty","{0:n0}")%>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                         ...
                         <asp:TemplateField HeaderText="Short/Over Ship Value ($)" Visible="true" ItemStyle-HorizontalAlign="Right" SortExpression="ShortShipValue">
                             ...
                             <asp:TemplateField HeaderText="SPO/SHIP Var" ItemStyle-HorizontalAlign="Right" Visible="true">
                                <ItemTemplate>
                                   <asp:Label ID="SPOShipVariance" runat="server" Text='<%#Eval("SPOShipVariance","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>
                               <FooterTemplate>
                             <asp:Label ID="LblFooterbuyerSPOShipVariance" runat="server" ></asp:Label>                                                                       
                              </FooterTemplate>
                             ...
                             <asp:TemplateField HeaderText="SPO/SHIP Var. Value" ItemStyle-HorizontalAlign="Right" Visible="true">
                                <ItemTemplate>
                                   <asp:Label ID="SPOShipVarValue" runat="server" Text='<%#Eval("SPOShipVarValue","{0:n}") %>'></asp:Label>
                                </ItemTemplate>
                               <FooterTemplate>
                             <asp:Label ID="LblFooterSPOShipVarValue" runat="server" ></asp:Label>                                                                       
                              </FooterTemplate>
                                                        ...
                                                        <div class="col-md-11">
                                                         <asp:GridView ID="GVBuyerDetails" ShowFooter="true" OnRowDataBound="GVBuyerDetails_RowDataBound" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" Font-Size="Small" ForeColor="Black" Style="max-width: 100%; min-width: 90%" OnSelectedIndexChanged="GVBuyerDetails_SelectedIndexChanged">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="BPOQTY" ItemStyle-HorizontalAlign="Right" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="BPOQTY" runat="server" Text='<%#Eval("BPOQTY","{0:n0}") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Commited Qty" ItemStyle-HorizontalAlign="Right" Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="CommitedQty" runat="server" Text='<%#Eval("CommitedQty") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Short/Over Qty (From BPO)" ItemStyle-HorizontalAlign="Right" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="ShortOver_Qty" ToolTip="(Shipped Qty - BPO Qty)" runat="server" Text='<%#Eval("ShortOver_Qty","{0:n0}") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                         <FooterTemplate>
    ...
    <td>
                                            ...
                                            <ContentTemplate>
                                                          <asp:LinkButton ID="lblStyleNo" runat="server" OnClick="lblStyleNo_Click"    />
                                                 </ContentTemplate>
                                                </asp:UpdatePanel>
                                                            ...
                                                            <asp:GridView ID="GVStyleDetails" ShowFooter="true" OnRowDataBound="GVStyleDetails_RowDataBound" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" Font-Size="Small" ForeColor="Black" Style="max-width: 100%; min-width: 90%">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="BPOQTY" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="BPOQTY" Font-Bold="true" Font-Size="Large" runat="server" Text='<%#Eval("BPOQTY","{0:n0}") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                         <FooterTemplate>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <table>
                                                ...
                                                <div class="col-md-1">
                                                        ...
                                                        <td>
                                                       <asp:LinkButton ID="LblStyle" runat="server" OnClick="lblStyleNo_Click"    />
...
<%--                                                                    <asp:TemplateField HeaderText="ColorCode" Visible="true">
                                                                   ...
                                                                   <%-- <asp:TemplateField HeaderText="FOB ($)" ItemStyle-HorizontalAlign="Right" Visible="false">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="StyleID" Visible="false">
                                                                     ...
                                                                     <asp:TemplateField HeaderText="SPO/SHIP Var" ItemStyle-HorizontalAlign="Right" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="SPOShipVariance" ToolTip="(Shipped Qty - SPO Qty)" runat="server" Text='<%#Eval("SPOShipVariance") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                         <FooterTemplate>
                                                        ...
                                                        <div class="col-md-11">
                                                            <asp:GridView ID="GVDeliveryDetails" ShowFooter="true" OnRowDataBound="GVDeliveryDetails_RowDataBound" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" Font-Size="Small" ForeColor="Black" Style="max-width: 100%; min-width: 90%">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Short/Over Qty  (From BPO)" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Right" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="ShortOver_Qty" ToolTip="Shipped Qty - BPO QTY" runat="server" Text='<%#Eval("ShortOver_Qty","{0:n0}") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                         <FooterTemplate>
...
<%--                            <asp:Label ID="labBuyerPONo" runat="server" Text='<%#Eval("BuyerPONo") %>'></asp:Label>--%>
    ...
    <br /> <br />
     ...
     <asp:Label ID="lbltotalSPOShipQty" runat="server" Text="" Visible="false"></asp:Label>
         ...
         <asp:Label ID="lblSPOShipShortOverQty" runat="server" Visible="False"></asp:Label>
        <asp:Label ID="lbltotalBPOSPOVariance" runat="server" Visible="False"></asp:Label>
         <asp:Label ID="lblSPOShipVarValuetotal" runat="server" Visible="False"></asp:Label>
         <asp:Label ID="lblLevelNo" runat="server" Visible="False" Text="0"></asp:Label>
         <asp:Label ID="lblLevelNoStyle" runat="server" Visible="False"></asp:Label>
    </div>
