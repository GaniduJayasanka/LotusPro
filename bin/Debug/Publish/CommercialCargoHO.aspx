<%@ page language="C#" enableeventvalidation="false" autoeventwireup="true" inherits="CommercialDeliveries, App_Web_b2ychy0x" %>
                ...
                <asp:GridView ID="gvDeliveryBD" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Shipment" ItemStyle-Width="110px" Visible="false">
                            <ItemTemplate>
                                <asp:CheckBox ID="Checkcompleate" CssClass="BigCheckBox" GroupName="RadioPlan" runat="server" />
                                Complete
                                <br />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Shipment Cancellation" HeaderStyle-Width="10px" SortExpression="">
                            <ItemTemplate>
                                <asp:ImageButton ID="imgbtnSHipmentCancel" OnClick="imgbtnSHipmentCancel_Click" ImageAlign="Bottom" runat="server" Height="40px" ImageUrl="~/images/CancelShip.png" ToolTip="Shipment Cancellation" Width="55px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="CancelRequest" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="labCancelRequest" runat="server" Visible="true" Text='<%#Eval("CancelRequest") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
