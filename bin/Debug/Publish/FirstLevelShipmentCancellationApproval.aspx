<%@ page language="C#" autoeventwireup="true" inherits="FirstLevelShipmentCancellationApproval, App_Web_b2ychy0x" %>
...
<head id="Head1" runat="server">
    <title>Second Level Approval</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-11">
                    <center><h3>Shipment Cancellation Approval - Finance</h3></center>
                </div>
            </div>
        </div>
