<%@ page language="C#" autoeventwireup="true" inherits="Login_Outside, App_Web_b2ychy0x" %>
        ...
        <asp:Panel ID="Panel3" runat="server" BorderColor="#FF6600" BorderStyle="Solid">
            <table class="style1">
                ...
                <tr>
                    ...
                    <td class="style2">
                        <asp:TextBox ID="txtusername" onkeydown = "return (event.keyCode!=222);"  runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style4">
