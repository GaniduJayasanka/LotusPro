<%@ page language="C#" autoeventwireup="true" inherits="RNote, App_Web_euilynsb" %>
...
<body>
    ...
    <asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
                                ...
                                <div class="row">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                              <asp:TextBox ID="txtAttention" Height="25px" Font-Size="Smaller" Text="Mr. Saman Dolamulla" Enabled="false" CssClass="form-control" runat="server"  ></asp:TextBox>
                                            </div>
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <asp:Button ID="BtnReset" runat="server" CssClass="btn btn-warning" Text="Reset" OnClick="BtnReset_Click" Height="25px"  Font-Size="Smaller" />
                                              <asp:Button ID="BtnConfirm" runat="server" CssClass="btn btn-success" Text="Send To Approval" Width="115px"  Height="25px"  Font-Size="Smaller"  OnClick="BtnFandprint_Click" />
                            ...
                            <div class="panel-body">
                                          ...
                                          <label class="col-md-1 control-label" style="font-size:smaller">Buyer PO</label>
                                           <div class="col-md-2">
                                             ...
                                             <asp:CheckBox ID="Checkfactoryerror"  style="font-size:smaller" runat="server" Text="Fac. Errror" AutoPostBack="true" OnCheckedChanged="Checkfactoryerror_CheckedChanged" />
                                                  ...
                                                  <asp:TextBox ID="txtFactoryFailPercentage" onkeypress="return isNumberKey(event)" runat="server" Width="40px" style="font-size:smaller" AutoPostBack="true" OnTextChanged="txtFactoryFailPercentage_TextChanged"></asp:TextBox>%
                                                </div>
                                          ...
                                          <asp:Label ID="Labdelqty" style="font-size:smaller" runat="server" Text=""></asp:Label>
                                           ...
                                           <asp:TextBox ID="TextShipedQty" style="font-size:smaller" Width="60px" AutoPostBack="true" runat="server"  OnTextChanged="TextShipedQty_TextChanged"></asp:TextBox>
                                              ...
                                              <div class="col-md-2">
                                                   ...
                                                   <asp:TextBox ID="txtPshipmentPercentage" onkeypress="return isNumberKey(event)" runat="server" Width="40px" style="font-size:smaller"  AutoPostBack="true" OnTextChanged="txtPshipment_TextChanged"></asp:TextBox>%&nbsp; 
                                                   </div>
                                                 <div class="col-md-1">
                                                  ...
                                                  </div>  <div class="auto-style1">
                                                       &nbsp;  &nbsp; 
                                                        <asp:TextBox ID="txtFrontEndPercentage" onkeypress="return isNumberKey(event)" AutoPostBack="true" runat="server" style="font-size:smaller" Width="40px" OnTextChanged="txtFrontEndPercentage_TextChanged"></asp:TextBox>
                                                %  
                                                </div>
                               ...
                               <div class="col-md-2">
                                                   <asp:CheckBox ID="Checkseviceprovi"  style="font-size:smaller" AutoPostBack="true" runat="server" Text="Service Provider" OnCheckedChanged="Checkseviceprovi_CheckedChanged" />
                                                     ...
                                                     <asp:TextBox ID="txtSPFailPercentage" onkeypress="return isNumberKey(event)" AutoPostBack="true"  Height="25px" Font-Size="Smaller" runat="server"  Width="40px" OnTextChanged="txtSPFailPercentage_TextChanged"></asp:TextBox>
                %
                                      </div>      
</div>
        ...
        <div class="row">
                    ...
                    <asp:GridView ID="gvDeliveryBD" OnRowDeleting="gvDeliveryBD_RowDeleting"  runat="server" AutoGenerateColumns="False" Font-Size="Smaller" BackColor="White" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" ForeColor="Black" GridLines="Both"  Width="90%">
                         ...
                         <asp:TemplateField HeaderText="Comment">
                          ...
                          <%--  <asp:CommandField ItemStyle-ForeColor="Red" ShowDeleteButton="true" />--%>
                            ...
                            <asp:TemplateField HeaderText="Senior Merchant" Visible="true">
                             ...
                             <asp:TemplateField HeaderText="Fac. End Error" Visible="true">
                                <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Service Pro. Error" Visible="true">
                                <ItemTemplate>
 ...
 <div class="col-md-2">
        ...
        <asp:DropDownList ID="DropBuyer" CssClass="form-control" runat="server" Height="25px" Font-Size="X-Small" ></asp:DropDownList>
         ...
         <asp:GridView ID="GridDeliverydetails" runat="server" AutoGenerateColumns="False" BackColor="White"
              BorderWidth="1px" CellPadding="4" EnableModelValidation="True" ForeColor="Black" Width="90%"  
             OnRowDataBound="GridDeliverydetails_RowDataBound"  Font-Size="Smaller">
                                <HeaderStyle BackColor="#333333" Font-Bold="True"  ForeColor="White" Wrap="False" />
                                <Columns>
                            ...
                            <ItemTemplate>                           
                                <asp:Label ID="labBPOID" runat="server" Visible="true" Text='<%#Eval("BPOID") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Color Qty" Visible="true">
                            <ItemTemplate>                           
                            ...
                            <ItemTemplate>                           
                                ...
                                <asp:TemplateField HeaderText="Cum. Shipped Qty" Visible="true">
                            <ItemTemplate>                           
                                <asp:Label ID="labCumulativShippedQtyy" runat="server" Visible="true" Text='<%#Eval("CumulativShippedQty") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>      
                 ...
                 <asp:TemplateField HeaderText="Laundry Wash Report"  Visible="true">
                            ...
                            <ItemTemplate>                           
                                <asp:Label ID="labSSBPO" runat="server" Visible="true" Text='<%#Eval("SSBPO") %>'></asp:Label>
                                      ...
                                      <asp:TemplateField HeaderText="Requested Status"  Visible="true">
                            <ItemTemplate>                           
                                <asp:Label ID="lblRequestedStatus" runat="server" Visible="true" Text='<%#Eval("RequestedStatus") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Partial Shipment Status"  Visible="true">
                            <ItemTemplate>                           
                                <asp:Label ID="lblPartialShipmentStatusWord" runat="server" Visible="true" Text='<%#Eval("PartialShipmentStatusWord") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>   
                                     <asp:TemplateField HeaderText="Partial Shipment Status"  Visible="false">
                            <ItemTemplate>                           
                                <asp:Label ID="lblPartialShipmentStatus" runat="server" Visible="true" Text='<%#Eval("PartialShipmentStatus") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>    
...
<div id="DivFooterRow" style="overflow:hidden">
            ...
            <asp:Label ID="lblOrderNo" Visible="false"   runat="server" Text=""></asp:Label>
                <asp:Label ID="LabelPartialShipmentStatus" Visible="false"   runat="server" Text=""></asp:Label>
            ...
            <asp:Label ID="lblSMSUserID" Visible="false"   runat="server" Text=""></asp:Label> 
            <br />
