<%@ page language="C#" autoeventwireup="true" inherits="HandedOver, App_Web_11yxmj2e" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-11">
                    <center><h3>Shipment Hand Over</h3></center>
                </div>
            </div>
        </div>
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="BPONo" Visible="true">
                    ...
                    <asp:TemplateField HeaderText="Del #" Visible="true">
                     ...
                     <asp:TemplateField HeaderText="Handed Over" Visible="true">
                        <ItemTemplate>                           
                              <asp:DropDownList ID="DDLHandedOver" runat="server" CssClass="form-control" Width="200px">
