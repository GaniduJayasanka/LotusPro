<%@ page language="C#" autoeventwireup="true" inherits="DBAcknowledgeReport, App_Web_10bhy3il" enableeventvalidation="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-11">
                    <center><h3>Acknowledged Debit Notes Report</h3></center>
                </div>
            </div>
        </div>
                    ...
                    <div class="panel-body">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <BDP:BasicDatePicker Width="50px" ID="DatePickerFromDate"  ToolTip="Debit Note Dispatched Date" runat="server" CssClass="form-control" />
                                </div>
                                ...
                                <div class="col-md-2">
                                   <BDP:BasicDatePicker ID="DatePickerToDate"  ToolTip="Debit Note Dispatched Date" runat="server" CssClass="form-control" />
                                </div>
 ...
 + "  END AS Plant FROM Commercial.dbo.Company Where SEQ NOT IN (6,1--%>
                            ...
                            <div class="col-md-2">
                             ...
                             <asp:Button ID="Buttontoexcel" runat="server" CssClass="btn btn-warning"  OnClick="Buttontoexcel_Click" Style="background-position: right; font-size: small; font-weight: 700; text-align: left; background-image: url('Images/Excel-32.png'); background-repeat: no-repeat;" Text="Export" Width="105px" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <asp:GridView ID="GVMSPShedule" runat="server"     DataKeyNames="DEBID" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="DB NOTE" SortExpression="" Visible="">
                        <ItemTemplate>
                            <asp:Label ID="DBNOTE" runat="server" Text='<%#Eval("DEBNumber") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="STYLE" SortExpression="" Visible="">
                     ...
                     <asp:TemplateField HeaderText="Buyer PO No" SortExpression="" Visible="">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="LIB. QUANTITY" ItemStyle-HorizontalAlign="Right" >
                        <ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="DISPATCHED QTY" ItemStyle-HorizontalAlign="Right" >
                        <ItemTemplate>
                            <asp:Label ID="DispatchedQty"   runat="server" Text='<%#Eval("DispatchedQty") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="DISPATCHED DATE" Visible="true" SortExpression="DispatchedDate">
                        <ItemTemplate>
                            <asp:Label ID="DispatchedDate" runat="server"  Text='<%#Eval("DispatchedDate","{0:dd/MMM/yyyy}") %>' ></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="DISPATCHED USER" Visible="true">
                        <ItemTemplate>
                            <asp:Label ID="DispatchedUser" runat="server" Text='<%#Eval("DispatchedUser") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="MDDID" SortExpression="" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="MDDID" runat="server" Text='<%#Eval("MDDID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<div id="DivFooterRow" style="overflow:hidden">
    ...
    <asp:Label ID="lblPlantName" runat="server" Text=""></asp:Label>
        ...
        <asp:Label ID="labelMDDID" runat="server" Text=""></asp:Label>
    </form>
</body>
</html>
