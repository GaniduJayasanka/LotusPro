<%@ page language="C#" autoeventwireup="true" inherits="RNApproval, App_Web_if0soheq" %>
    ...
    <asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-11">
                    <center><h4>Shipment Release Note Approval</h4></center>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table>
    <tr>
        <td> <label class="col-md-1 control-label" >Shipment No</label></td>
        <td><asp:Label ID="lblShipmentNo" class="col-md-2 control-label" runat="server" Text=""></asp:Label></td>
    </tr>
  <tr>
      <td><label class="col-md-1 control-label">Attention</label></td>
      <td> <asp:Label ID="lblAttention" class="col-md-2 control-label" runat="server" Text=""></asp:Label></td>
      </tr>
    <tr>
        <td><label class="col-md-1 control-label">Plant</label></td>
         <td> 
               <asp:Label ID="lblPlant" CssClass="blink" Font-Bold="true" Font-Size="Larger" ForeColor="#cc0000" runat="server" Text=""></asp:Label>
            </td>
         </tr>
    <tr>
         <td> <label class="col-md-1 control-label">D. Point</label></td>
         <td><asp:Label ID="lblDelPoint" class="col-md-1 control-label" runat="server" Text=""></asp:Label></td>
    </tr>
    <tr>
        <td>   <label class="col-md-2 control-label">Ship Date</label></td>
         <td> <asp:Label ID="lblShipdate" class="col-md-2 control-label" runat="server" Text=""></asp:Label></td>
    </tr>
     <tr>
        <td><label class="col-md-1 control-label" >Dis. By</label></td>
         <td> <asp:Label ID="lblDispatchBy" class="col-md-2 control-label" runat="server" Text=""></asp:Label></td>
    </tr>
     <tr>
        <td>  <label class="col-md-1 control-label">Vehicle No</label></td>
         <td> <asp:Label ID="lblvehicleNo" class="col-md-1 control-label" runat="server" Text=""></asp:Label></td>
    </tr>

    <tr>
        <td>   <label class="col-md-1 control-label">Type</label></td>
         <td><asp:Label ID="lblVehicleType" class="col-md-1 control-label" runat="server" Text=""></asp:Label></td>
    </tr>

                             <tr>
        <td><label class="col-md-2 control-label">Transported By</label></td>
         <td><asp:Label ID="lblTransportBy" class="col-md-1 control-label" runat="server" Text=""></asp:Label></td>
    </tr>
<tr>
    <td colspan="2"><label class="col-md-2 control-label" style="height: 20px">Shipment Comment</label></td>
</tr>
                            <tr>
    <td colspan="2"><asp:Label ID="LblShipComment" class="col-md-3 control-label" runat="server" Text=""></asp:Label></td>
</tr>
                             <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                               <tr>
                                   <td colspan="2">  <asp:Button ID="BtnApprove" runat="server" CssClass="btn btn-success" Text="Approve" Width="115px"  Height="25px"  Font-Size="Smaller"  OnClick="BtnApprove_Click" />
         ...
         <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <table>
                                    <tr>
                                         <td> <label class="col-md-1 control-label" style="font-size:smaller">Style</label></td>
                                         <td> <asp:Label ID="LabStyle"  style="font-size:smaller"  runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>  <label class="col-md-1 control-label" style="font-size:smaller">Buyer PO</label></td>
                                        <td> <asp:Label ID="LabBPO" style="font-size:smaller" runat="server" Text=""></asp:Label></td>

                                        </tr>
                                    <tr>
                                        <td>  <label class="col-md-1 control-label" style="font-size:smaller">Color</label></td>
                                         <td><asp:Label ID="Labcolour" style="font-size:smaller" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>  <label class="col-md-2 control-label" style="font-size:smaller">Committed Qty</label></td>
                                         <td>  <asp:Label ID="Labdelqty" style="font-size:smaller" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td> <label class="col-md-1 control-label" style="font-size:smaller">Ship Qty</label></td>
                                         <td> <asp:Label ID="lblShipQty" style="font-size:smaller" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td><label class="col-md-2 control-label" style="font-size:smaller"  >No.Of Cartoons</label></td>
                                         <td>  <asp:Label ID="lblNoOfCartoons" style="font-size:smaller" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td><label class="col-md-2 control-label" style="font-size:x-small"  >Physically Handed Over Date</label></td>
                                        <td> <asp:Label ID="lblPhyHandOverdate" style="font-size:smaller" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td><label class="col-md-3 control-label" style="font-size:x-small"  >Reason For Delayed update</label></td>
                                         <td>  <asp:Label ID="lblDelayedUpdateReason" style="font-size:smaller" runat="server" Text=""></asp:Label></td>
                                        </tr>
                                    <tr>
                                        <td><label class="col-md-2 control-label" style="font-size:smaller"  >Partial Shipment</label></td>
                                         <td>  <asp:CheckBox ID="ChkPartialShipment"   style="font-size:smaller"   AutoPostBack="true" runat="server" OnCheckedChanged="ChkPartialShipment_CheckedChanged"  /> &nbsp;&nbsp;
                                          
                                                   <asp:TextBox ID="txtPshipmentPercentage" onkeypress="return isNumberKey(event)" runat="server" Width="50px" style="font-size:smaller"  AutoPostBack="true" OnTextChanged="txtPshipment_TextChanged"></asp:TextBox>%&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td><label class="col-md-1 control-label" style="font-size:smaller">Debit Party</label></td>
                                         <td><asp:CheckBox ID="Checkfactoryerror"  style="font-size:x-small" runat="server" Text="Fac. Errror" AutoPostBack="true" OnCheckedChanged="Checkfactoryerror_CheckedChanged" />
                                        ...
                                        <tr>
                                            <td></td>
                                           <td>  
                                             <asp:TextBox ID="txtFactoryFailPercentage" onkeypress="return isNumberKey(event)"  runat="server" Width="50px" style="font-size:smaller" AutoPostBack="true" OnTextChanged="txtFactoryFailPercentage_TextChanged"></asp:TextBox>%
                                            
                                         </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                         <td>   <asp:CheckBox ID="Checkfruntend"  style="font-size:x-small" AutoPostBack="true" runat="server" Text="Front End " OnCheckedChanged="Checkfruntend_CheckedChanged" />
                                           </td>
                                        </tr>
                                           <tr>
                                        <td></td>
                                               <td>
                                             <asp:TextBox ID="txtFrontEndPercentage" onkeypress="return isNumberKey(event)"   AutoPostBack="true" runat="server" style="font-size:smaller" Width="50px" OnTextChanged="txtFrontEndPercentage_TextChanged"></asp:TextBox>
                                                % 
                                         </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                         <td> 
                                             <asp:CheckBox ID="Checkseviceprovi"  style="font-size:x-small" AutoPostBack="true" runat="server" Text="Service Pro." OnCheckedChanged="Checkseviceprovi_CheckedChanged" />
                                             </td>
                                        </tr>
                                           <tr>
                                        <td></td>
                                               <td>
                                                <asp:TextBox ID="txtSPFailPercentage" onkeypress="return isNumberKey(event)"  AutoPostBack="true"  Height="25px" Font-Size="Smaller" runat="server"  Width="50px" OnTextChanged="txtSPFailPercentage_TextChanged"></asp:TextBox>
                %
                                                </td>
                                    </tr>
                                    <tr>
                                        <td><label  style="font-size:x-small">Reasons For Failure</label></td>
                                        <td> <asp:TextBox ID="txtShipComments0" style="font-size:smaller" runat="server" Text=""></asp:TextBox></td>

                                    </tr>
                                      <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                                     <tr><td> <asp:Button ID="BtnUpdate" runat="server" CssClass="btn btn-warning"  OnClick="BtnUpdate_Click" Style="background-position: right; font-size: smaller; font-weight: 700; text-align: left; background-image: url('Images/add.png');  background-repeat: no-repeat;" Text="Update" Width="75px" />
                                                                     </td><td></td></tr>
            ...
            <div class="col-md-12">
                ...
                <div style="overflow-x:auto;">
                    <asp:GridView ID="gvDeliveryBD" RowStyle-Wrap="false"   runat="server" AutoGenerateColumns="False" Font-Size="Smaller" BackColor="White" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" ForeColor="Black" GridLines="Both" Width="40%" >
