<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CusReviewReport.aspx.cs" Inherits="CusReviewReport" %>
...
<head>
    ...
    <title>LotusPro | Customer Review Management</title>
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                     <li class="breadcrumb-item"><a href="ReportHome.aspx">Reports</a></li>
                                    <li class="breadcrumb-item"><a href="#">Customer Reviews</a></li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
              ...
              <asp:Button ID="BbtnClear" class="btn btn-warning start" runat="server" Width="100px" Height="35px" Style="margin-left: 5px" Text="Clear" OnClick="BbtnClear_Click" />
               <asp:Button ID="ButtonExport" class="btn btn-success start" runat="server" Width="100px" Height="35px" Style="margin-left: 5px" Text="Export" OnClick="ButtonExport_Click"  />                                       
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <%--<h5>Started Tasks</h5>--%>
                                <asp:GridView ID="gvCustomerFeedback" runat="server" AutoGenerateColumns="False" Font-Size="Small" >
                                    <HeaderStyle BackColor="#333333" Font-Bold="True" ForeColor="White" />
                                    <Columns>
                                        <asp:TemplateField  HeaderText="CRID" Visible="false">
                                            <itemtemplate>
                                                <asp:Label ID="lblCRID" runat="server" Font-Bold="true" Text='<%#Eval("CRID") %>'></asp:Label>
                                            </itemtemplate>
                                        </asp:TemplateField>
                                                       <asp:TemplateField HeaderText="Customer Review Id" Visible="true">
                                                             <ItemTemplate>
                                                                  <asp:LinkButton ID="BtnCustomerReviewId"  Font-Bold="true" runat="server" CssClass="paraGraphtext" Text='<%# Eval("CustomerReviewId") %>' Font-Size="Small"  ></asp:LinkButton>
                                                              </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="First Name" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labFirstName" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("FirstName") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Last Name" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="lblLastName" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("LastName") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Email" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="lblEmail" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Email") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Contact No" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labContactNo" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("ContactNo") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Country" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labCountry" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Country") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Inquiry" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labInquiry" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Inquiry") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                          <asp:TemplateField HeaderText="Rating" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labRating" runat="server" Font-Bold="true" Visible="true" >
                                                                 <span class="star-rating">
                                                                     <%# GetStarRatingStars(Eval("StarRating")) %>
                                                                 </span>
                                                                   </asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Created Date" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="CreatedAt" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("CreatedAt","{0:dd/MMM/yyyy}") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         
                                         <asp:TemplateField HeaderText="">
                                                            <ItemTemplate>
                                                                <asp:Button ID="btnAction" runat="server" Text="Action" class="btn btn-success start"  OnClick="btnAction_Click" />
