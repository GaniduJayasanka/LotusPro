<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MasterTKTEvents.aspx.cs" Inherits="MasterTKTEvents" %>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h5 class="m-0">Tickets Events & Types | Master </h5>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
            ...
            <div class="card ">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>Event Index. : </label>      <asp:TextBox ID="TextBox1" runat="server"  class="form-control" ></asp:TextBox>                 
                </div>               
              </div>
                 ...
                 <div class="col-md-8">
                <div class="form-group">
                  <label>Event Name :</label>           <asp:TextBox ID="TextBox2" runat="server"  class="form-control" ></asp:TextBox>               
                </div>               
              </div>
             
             <hr />
<div class="form-group">
                   <asp:Button ID="BtnEventCreate" class="btn btn-danger start" runat="server" Width="270px" Text="Create" OnClick="BtnEventCreate_Click" />
                      <asp:Button ID="BtnEventCancel" class="btn btn-warning start" runat="server" Width="270px" Text="Cancel" OnClick="BtnEventCancel_Click"  />
           ...
           <asp:GridView ID="GVEventIndex" runat="server" AutoGenerateColumns="False" class="table table-bordered">
                <HeaderStyle BackColor="#333333" Font-Bold="True" ForeColor="White" />
               <Columns>
                                                        <asp:TemplateField HeaderText="Projectid" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Projectid" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Projectid") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Event Index" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:Label ID="PIndex" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("PIndex") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                   <asp:Button ID="BtnVoid" class="btn btn-danger start" runat="server" Width="270px" Text="Void"  />
                      <asp:Button ID="BtnClear" class="btn btn-warning start" runat="server" Width="270px" Text="Cancel"  />
