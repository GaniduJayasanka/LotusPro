            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h5 class="m-0">My To-Do List (Tasks - Pending & Inprogress)</h5>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="HelpDesk.aspx">Home</a></li>
                                    <li class="breadcrumb-item"><a href="HelpDesk.aspx">HelpDesk Management</a></li>
                                    <li class="breadcrumb-item"><a href="ToDoList.aspx">My To-Do List</a></li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <asp:GridView ID="gvToDoList" runat="server" AutoGenerateColumns="False" DataKeyNames="TID" CssClass="ReceivedTaskTable" Font-Size="Small" OnRowDataBound="gvToDoList_RowDataBound">
                                    <HeaderStyle BackColor="#333333" Font-Bold="True" ForeColor="White" />
                                    <Columns>

                                        <asp:TemplateField  HeaderText="TID" Visible="false">
                                            <itemtemplate>
                                                <asp:Label ID="lblToDoListTID" runat="server" Font-Bold="true" Text='<%#Eval("TID") %>'></asp:Label>
                                            </itemtemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField  HeaderText="Reference No" ItemStyle-Width="150px">
                                            <itemtemplate>
                                                <asp:Label ID="Ref_No" runat="server" Font-Bold="true" Visible="false" Text='<%#Eval("Ref_No") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField  HeaderText="Task Description" ItemStyle-Width="650px">
                                            <itemtemplate>
                                                <asp:Label  runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("TaskDescription") %>'></asp:Label>
                                            </itemtemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Priority" Visible="true">
                                                        ...
                                                        <asp:TemplateField HeaderText="Create Date" Visible="true">
                                                         ...
                                                         <asp:TemplateField HeaderText="Assigned User" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:Label ID="AssignedUser" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("AssignedTo") %>' ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Approved/ Rejected By" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:Label ID="ApprovedBy" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("AssignedBy") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                        <%--<asp:TemplateField  HeaderText="Request Date" ItemStyle-Width="100px">
                                            <itemtemplate>
                                                <asp:Label  runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("RequestCompletion" , "{0:dd/MM/yyyy}") %>'></asp:Label>
                                            </itemtemplate>
                                        </asp:TemplateField>--%>
                                          <asp:TemplateField HeaderText="StatusID" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="StatusID" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("StatusID") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Start" ItemStyle-Width="100px" HeaderStyle-CssClass="btnClass" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%--<asp:CheckBox ID="ChkStart" runat="server" AutoPostBack="True" OnCheckedChanged="ChkStart_CheckedChanged"/>--%>
                                                <asp:ImageButton style="width: 55px; height: 55px" ID="btnStart" runat="server" CommandName="Start" ImageUrl="~/images/Start.png" OnClick="btnStart_Click" />
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Complete" ItemStyle-Width="100px" HeaderStyle-CssClass="btnClass" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%--<asp:CheckBox ID="ChkComplete" runat="server" AutoPostBack="True" OnCheckedChanged="ChkComplete_CheckedChanged"/>--%>
                                                <asp:ImageButton style="width: 55px; height: 55px" ID="btnComplete" runat="server" CommandName="Complete" ImageUrl="~/images/Complete.png" OnClick="btnComplete_Click"/>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <%--<asp:TemplateField  HeaderText="Status" Visible="true" ItemStyle-Width="100px">
                                            <itemtemplate>
                                                <asp:Label ID="Status" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Status") %>'></asp:Label>
                                            </itemtemplate>
                                        </asp:TemplateField>--%>
