<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserPriviledges.aspx.cs" Inherits="UserPriviledges" %>
...
<head>
    ...
    <title>LotusPro | User Priviledges</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5>User Priviledges Grant</h5>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="Home.aspx">Home</a></li>
                <li class="breadcrumb-item"><a href="AdminPanel.aspx">Admin Panel</a></li>
              <li class="breadcrumb-item active">User Priviledges Grant</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        ...
                        <br />
                        <asp:DropDownList ID="DDLUserName"   class="form-control" Height="30px" Font-Size="Smaller"   AutoPostBack="true"    runat="server" OnSelectedIndexChanged="DDLUserName_SelectedIndexChanged"   ></asp:DropDownList>
                      </div>
                    </div>                    
                     <div class="col-sm-4">
                      <!-- text input -->
                    ...
                    <Columns>
                     ...
                     <asp:TemplateField HeaderText="Web Form" Visible="true" >
                            ...
                            <ItemTemplate>                           
                               ...
                               <asp:TemplateField HeaderText="Priviledge" Visible="true"  ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>                           
                                <asp:CheckBox ID="CheckBoxPriviledge" runat="server" />  
                            </ItemTemplate>                                         
                        </asp:TemplateField>                      
                                </Columns>
                            </asp:GridView>
