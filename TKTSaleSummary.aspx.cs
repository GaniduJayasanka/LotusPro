...
public partial class TKTSaleSummary : System.Web.UI.Page
{
    SqlConnection conn;
    static string url = "TKTSaleSummary.aspx";
    static int formid = 8;
    static int userId = 0;
    ...
    private DataTable GVBind()
    {
        ...
        using (SqlCommand cmd = new SqlCommand("exec [VM].[dbo].sp_TicketSaleSummary '" + BasicDatePickerFromDate.Text + "','" + BasicDatePickerToDate.Text + "' ", conn))
        {
