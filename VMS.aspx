<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VMS.aspx.cs" Inherits="VMS" %>
...
<head>
 ...
 <link rel="shortcut icon" type="image/ico" href="dist/img/lotusProLog.ico" />
  ...
  <title>LotusPro | Visitor Management System</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0">Procurement Management System</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Procurement Management System</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- /.content-header -->
      ...
      <div class="container-fluid">
               ...
               <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="TaskCategory.aspx">
                            <div class="info-box">
                                ...
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Request Categories</span>
                                </div>
                            </div>
                        </a>
                       </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="TaskCreate.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-green">
                                    <img src="Images/TaskCreate.png" width="60%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Task Create</span>
                                </div>
                            </div>
                        </a>
                       </div>
          ...
          <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="TaskAssign.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-lightblue">
           ...
           <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="ToDoList.aspx">
                            <div class="info-box">
          ...
          <div class="secondTitle">
           ...
           <div class="row">
               ...
               <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="CompletedTasks.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-secondary">
                                    <img src="Images/InhandStock.png" width="90%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Progress Monitoring</span>
                                </div>
                            </div>
                        </a>
                       </div>
