...
<head>
 ...
 <link rel="shortcut icon" type="image/ico" href="dist/img/lotusProLog.ico" />
  ...
  <title>LotusPro | Admin Panel</title>
...
<div class="wrapper">
      ...
      <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="Form.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-lightblue">
                                    <img src="Images/sizeFob.png" width="90%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Web Forms</span>
                                </div>
                            </div>
                        </a>
                       </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="UserCreate.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-green">
                                    <img src="Images/UserCreate.png" width="60%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">User Create</span>
                                </div>
                            </div>
                        </a>
                       </div>
              ...
              <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="UserPasswordChange.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-red">
                                    <img src="Images/pswChange.png" width="60%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
          ...
          <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="UserPriviledges.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-yellow">
                                    <img src="Images/UserPriviledges.png" width="70%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">User Priviledges</span>
                                </div>
                            </div>
                        </a>
                       </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="https://houseoffashions.lk/">Colombo Lotus Tower</a>.</strong>
    All rights reserved.
