                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Tasks Finder</a></li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <label>Task Status</label>
                   <asp:DropDownList ID="DDLSearch" Height="30px" runat="server" class="form-control" >
              ...
              <asp:Button ID="BbtnClear" class="btn btn-warning start" runat="server" Width="100px" Height="35px" Style="margin-left: 5px" Text="Clear" OnClick="BbtnClear_Click" />
               <asp:Button ID="ButtonExport" class="btn btn-success start" runat="server" Width="100px" Height="35px" Style="margin-left: 5px" Text="Export" OnClick="ButtonExport_Click" />                                       
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <%--<h5>Started Tasks</h5>--%>
                                <asp:GridView ID="gvCompletedTasks" runat="server" AutoGenerateColumns="False" Font-Size="Small" OnRowDataBound="gvCompletedTasks_RowDataBound">
                                                ...
                                                <asp:Label ID="lblToDoListTID" runat="server" Font-Bold="true" Text='<%#Eval("TID") %>'></asp:Label>
                                                       ...
                                                       <asp:TemplateField HeaderText="Ref No" Visible="true">
                                                         ...
                                                         <asp:TemplateField HeaderText="Subject" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labSubTaskSubject" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Subject") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Task Description" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labSubTaskDescription" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("TaskDescription") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Status" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labSubTaskStatus" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("Status") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         ...
                                                         <asp:TemplateField HeaderText="Complete Before" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="RequestCompletion" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("RequestCompletion","{0:dd/MMM/yyyy}") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Create User" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labCreateUser" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("CreateUser") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Create Date" Visible="true">
                                                             <ItemTemplate>
                                                               <asp:Label ID="labCreateDate" runat="server" Font-Bold="true" Visible="true" Text='<%#Eval("CreateDate","{0:dd/MMM/yyyy}") %>'></asp:Label>
                                                             </ItemTemplate>
                                                         </asp:TemplateField>
