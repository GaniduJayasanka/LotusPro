  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0">Tour Guide Management System</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Tour Guide Management System</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="TGRegistration.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-lightblue">
                                    <img src="Images/TGRegi.png" width="90%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Tour Guide Registration</span>
                                </div>
                            </div>
                        </a>
                       </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="TGPClaimReport.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-green">
                                    <img src="Images/TGClaim.png" width="110%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Tour Guide Points Claim</span>
                                </div>
                            </div>
                        </a>
                       </div>
          ...
          <div class="secondTitle">
           ...
           <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="TGPReport.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-orange">
                                    <img src="Images/NclaimRpt.png" width="66%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Tour Guide Points <br />(Not Claimed)</span>
                                </div>
                            </div>
                        </a>
                       </div>
               ...
               <div class="col-md-3 col-sm-6 col-12">
                    <a class="col-md-4 col-sm-6 col-xs-4" href="TGPClaimed.aspx">
                            <div class="info-box">
                                <span class="info-box-icon bg-secondary">
                                    <img src="Images/claimRpt.png" width="60%"/>
                                </span>
                                <div class="info-box-content cont_text_pading">
                                    <span class="info-box-text">Tour Guide Points <br />(Claimed)</span>
                                </div>
                            </div>
                        </a>
                       </div>
