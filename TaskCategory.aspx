<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaskCategory.aspx.cs" Inherits="TaskCategory" %>
...
<head>
    ...
    <title>LotusPro | Task Category Creation</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h5 class="m-0">Main|Sub Task Category Creation</h5>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Task Category Creation</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12" style="width: 100%">
                                            ...
                                            <div id="DivFindProducts" runat="server" class="card card-secondary">
                                                <!-- card-header -->
                                                <!--<div class="card-header">
                                                    <h3 class="card-title">Main Task</h3>
                                                </div>-->
                                                <!-- /.card-header -->
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row" style="display: flex; justify-content: space-between">
                                                        ...
                                                        <div class="col" style="display: flex">
                                                            <asp:Label ID="lblmaintask" Style="width: 100px" runat="server" Visible="true" Text="Main Task"></asp:Label>
                                                            <asp:TextBox ID="txtmainTask" Height="30px" Width="500px" runat="server" class="form-control"></asp:TextBox>
                                                        </div>

                                                        <div class="col" style="display: flex; margin-left: 120px">
                                                            <asp:Button ID="BtnSave" class="btn btn-info start" runat="server" Width="120px" Text="Save" onClick="BtnSave_Click"/>
                                                            <asp:Button ID="btnClear" class="btn btn-warning start" runat="server" Width="120px" Text="Cancel" OnClick="btnClear_Click"/>
                                            ...
                                            <div id="Div1" runat="server" class="card card-secondary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row" style="display: flex; justify-content: space-between">
                                                        ...
                                                        <div class="col" style="display: flex">
                                                            <label style="width: 100px">Sub Task</label>
                                                            <asp:DropDownList ID="DDLmainTask" class="form-control" Height="30px" Width="300px" Font-Size="Smaller" runat="server"></asp:DropDownList>
                                                            <asp:TextBox ID="txtSubTask" Height="30px" Width="300px" runat="server" class="form-control" Style="margin-left: 20px"></asp:TextBox>
                                                        </div>

                                                        <div class="col" style="display: flex">
                                                            <asp:Button ID="Button1" class="btn btn-info start" runat="server" Width="120px" Text="Save" OnClick="Button1_Click"/>
                                                            <asp:Button ID="ButtonCancel" class="btn btn-warning start" runat="server" Width="120px" Text="Cancel"  OnClick="ButtonCancel_Click" />
                                                            <asp:Button ID="ButtonFind" class="btn btn-success start" runat="server" Width="120px" Text="Find" OnClick="ButtonFind_Click" />
                                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <asp:GridView ID="GVTask" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="MainTask" Visible="true">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblMainTask" runat="server" Visible="true" Text='<%#Eval("MainTask") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
